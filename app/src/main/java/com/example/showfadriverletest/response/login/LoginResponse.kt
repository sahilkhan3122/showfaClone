package com.example.showfadriverletest.response.login
...
data class LoginResponse(
	...
	@field:SerializedName("meter_check")
	val meterCheck: MeterCheck? = null
):BaseResponse(){
	...
	data class DriverDocs(
		...
		val vehicleRegExpiredDate: Any? = null,
